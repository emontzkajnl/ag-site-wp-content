	...
	<div id="content-wrapper">
		...
		<div id="content-main">
			...
			<div id="home-main">
				...
				<h3 class="home-widget-header category-title"><?php single_cat_title(); ?></h3>
					...
					<ul class="home-list cat-home-widget infinite-content">
						...
						<?php $mvp_slider_cat = get_option('mvp_slider_cat'); if ($mvp_slider_cat == "true") { ?>
							...
							if( $wp_query->current_post === 5 ) {
							   // echo '<div style="width:100%; text-align:center;">' . do_shortcode('[in-content-ad-narrow]') . '</div>';
							   echo '<div style="width:100%; text-align:center; height:20px; background:#ccc;">Advertisement</div>';
							}
							?>							
