					...
					<div class="shadow-middle">
						<div id="middle-img">
							...
							<?php } else { ?>
								...
								<?php $recent = new WP_Query('posts_per_page=1&tag=editors-pick'); while($recent->have_posts()) : $recent->the_post(); $do_not_duplicate[] = $post->ID; if (isset($do_not_duplicate)) { ?>
...
<!-- Main Content -->
	<div id="content-wrapper">
		...
		<div id="content-main" class="top-border-orange">
				...
				<div class="home-widget">
					...
					<ul class="split-columns infinite-content">
						...
						<?php $mvp_slider = get_option('mvp_slider'); $mvp_posts = get_option('mvp_featured_posts'); if (($mvp_slider == "true") || ($mvp_posts == "true")) { ?>
							...
							<?php if (isset($do_not_duplicate)) { $mvp_posts_num = get_option('mvp_posts_num'); $paged = (get_query_var('page')) ? get_query_var('page') : 1; query_posts(array( 'posts_per_page' => 4, 'post__not_in'=>$do_not_duplicate, 'paged' =>$paged )); if (have_posts()) : while (have_posts()) : the_post(); ?>
