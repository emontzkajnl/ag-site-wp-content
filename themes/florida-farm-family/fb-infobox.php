...
if ( ! function_exists( 'swp1_add_buttons' ) ) {
  function swp1_add_buttons( $plugin_array ) {
      $plugin_array['infoboxleft'] = get_stylesheet_directory_uri().'/js/tinymce_buttons.js';
      $plugin_array['infoboxcenter'] = get_stylesheet_directory_uri().'/js/tinymce_buttons.js';
      $plugin_array['infoboxright'] = get_stylesheet_directory_uri().'/js/tinymce_buttons.js';
      return $plugin_array;
  }
}
if ( ! function_exists( 'swp1_register_buttons' ) ) {
  function swp1_register_buttons( $buttons ) {
      array_push( $buttons, 'infoboxleft' );
      array_push( $buttons, 'infoboxcenter' );
      array_push( $buttons, 'infoboxright' );
      return $buttons;
  }
}
