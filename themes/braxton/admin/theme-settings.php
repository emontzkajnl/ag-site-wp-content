...
$options[] = array( "name" => __('Logo','mvp-text'),
			"desc" => __('Select a file to appear as the logo for your site.','mvp-text'),
			"id" => $shortname."_logo",
			"std" => "",
			"type" => "upload");
...
$options[] = array( "name" => __('Header Font','mvp-text'),
			"desc" => __('Enter the font name for the headers around the site.','mvp-text'),
...
$options[] = array( "name" => __('Featured Posts Layout','mvp-text'),
			"desc" => __('Choose your layout for the Featured Posts section.','mvp-text'),
