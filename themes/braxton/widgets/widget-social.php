		...
		?>
				...
				<div id="content-social">
					<ul>
						...
						<li class="fb-item">
							<a href="<?php echo get_option('mvp_facebook'); ?>" alt="Facebook" class="fb-but" target="_blank"></a>
						</li>
						<?php } ?>
						<?php if(get_option('mvp_twitter')) { ?>
						<li class="twitter-item">
							<a href="<?php echo get_option('mvp_twitter'); ?>" alt="Twitter" class="twitter-but" target="_blank"></a>
						</li>
						<?php } ?>
						<?php if(get_option('mvp_pinterest')) { ?>
						<li class="pinterest-item">
							<a href="<?php echo get_option('mvp_pinterest'); ?>" alt="Pinterest" class="pinterest-but" target="_blank"></a>
						</li>
						<?php } ?>
						...
						<li class="instagram-item">
							<a href="<?php echo get_option('mvp_instagram'); ?>" alt="Instagram" class="instagram-but" target="_blank"></a>
						</li>
						<?php } ?>
						<?php if(get_option('mvp_youtube')) { ?>
						<li class="youtube-item">
							<a href="<?php echo get_option('mvp_youtube'); ?>" alt="YouTube" class="youtube-but" target="_blank"></a>
						</li>
						<?php } ?>
						<?php if(get_option('mvp_linkedin')) { ?>
						<li class="linkedin-item">
							<a href="<?php echo get_option('mvp_linkedin'); ?>" alt="Linkedin" class="linkedin-but" target="_blank"></a>
						</li>
						<?php } ?>
