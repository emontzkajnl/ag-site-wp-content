...
?>
	...
	<header class="page-header">
			...
			<!-- set up two columns -->
			<h1>Tennessee Events Calendar</h1>
		...
		<?php if ( have_posts() ) : ?>
			...
			while ( have_posts() ) :
				...
				<div class="col-12 m-col-12 thf-event-list">
					<!-- <div> -->
					<div class="date-cube">
						<?php echo '<span class="month">'.$start_month.'</span><br /><span class="day">'.$start_day.'</span>'; ?>
					</div>
					<!-- </div> -->
					<div class="thf-event-list__text-area">
					<h2 class="thf-event-list__title"><a class="unstyle-link" href="<?php echo get_the_permalink(  ); ?>"><?php echo get_the_title(); ?></a></h2>
					<p class="thf-event-list__date"><?php echo $date_string; ?></p>
					<p class="thf-event-list__location"><?php echo $location; ?>, TN</p>
					</div>
