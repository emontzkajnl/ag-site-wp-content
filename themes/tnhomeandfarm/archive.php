		...
		<?php if ( have_posts() ) : ?>
            ...
            $q = get_queried_object(  );
					if (is_category(  )) {
						...
						echo '<p class="cat-description">'.$q->category_description.'</p>';
					} elseif (is_author()){
					...
					<div class="alm-container container">
				<div class="row">
			...
			<button data-cat="<?php echo $query_vars['cat']; ?>" data-tag="<?php echo $query_vars['tag']; ?>" data-author="<?php echo $query_vars['author']; ?>" data-paged="<?php echo $paged; ?>" class="background__primary font__serif" id="load-more-thf-cats">LOAD MORE</button>
			</div>
